...
export const teachers: Teacher[] = [
...

  {
    ...
    role: ["清大電機碩士"],
    class: ["APCS", "AI課程"],
    imageUrl: "avatar/avatar_9.png",
  },
  {
    name: "Yoga",
    role: ["交大財經博士"],
    class: ["SAT", "python", "AP Calculus", "AP Statistics"],
    imageUrl: "avatar/avatar_10.png",
  },
  {
    name: "Yuzent",
    role: ["競技程式專家"],
    class: ["APCS", "競技程式比賽"],
    imageUrl: "avatar/avatar_11.png",
  },
  {
    name: "Yano",
    role: ["十年網頁工程師"],
    class: ["國小程式邏輯培訓與養成", "python", "網頁", "作品集"],
    imageUrl: "avatar/avatar_12.png",
  },
  {
    name: "Andy",
    role: ["交大資訊碩士"],
    class: ["資安專家", "黑客松專家"],
    imageUrl: "avatar/avatar_13.png",
  },
];
